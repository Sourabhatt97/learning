...
class billingcontroller extends Controller
{
    ...
    public function paymenttype(Request $request)
    {
    	...
    	{
    		return view('layout.front.payment.stripegetway');
    	}
    } 

   /* public function printinvoicepdf(Request $request, $id)
    {    	
    	$user_id = Auth::user()->id;
    	...
    	$address = Billing_address::where('id',$id)->get();	
        
        $pdf = PDF::loadView('layout.front.checkout.pdf',['products'=>$products,'address'=>$address]);  
        $a = $pdf->download('invoice.pdf');
